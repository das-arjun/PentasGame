...
controller.menu.onEvent(ControllerButtonEvent.Pressed, function () {
    game.splash("You've found my easter egg!")
    myEnemy.sayText("burger")
    textSprite = textsprite.create("Created by Arjun Das")
    textSprite.setPosition(75, 75)
    textSprite.setText("Created by Arjun Das")
    while (true) {
        spriteutils.drawTransparentImage(img`
            ...
            . . . c c c c c e e e e e . . . 
            `, scene.backgroundImage(), myEnemy.x, myEnemy.y)
pause(100)
    }
})
